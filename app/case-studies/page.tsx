...
export const metadata = {
  title: "Case Studies | Oceanic Advisors",
  description: "Explore real-world maritime case studies showcasing Oceanic Advisors' expertise in vessel construction, arbitration, emergency response, and fleet management.",
  keywords: [
  ...
  openGraph: {
    title: "Case Studies | Oceanic Advisors",
    description: "Explore real-world maritime case studies showcasing Oceanic Advisors' expertise in vessel construction, arbitration, emergency response, and fleet management.",
    url: "https://oceanicadvisors.org/case-studies",
    images: ["/meta.png"],
  },
  twitter: {
