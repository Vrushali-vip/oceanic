...
export default function Team() {
  ...
  const teamMembers = [
    ...
    },
    {
      name: "Amit Kumar Nandi",
      role: "Technical Head",
      bio: "A seasoned maritime professional with vast operational expertise across LPG carriers, oil tankers, bulk carriers, chemical tankers, and container vessels.",
      image: "/team3.jpg",
      icon: <Ship className="h-6 w-6 text-orange-500" />,
      expertise: ["LPG Carriers", "Oil Tankers", "Bulk Carriers", "Chemical Tankers", "Container Vessels"],
    },
    {
      ...
      bio: "With over seven years of experience in the shipping industry, she ensures smooth personnel management, regulatory compliance, and operational alignment.",
      image: "/team2.jpg",
      icon: <Users className="h-6 w-6 text-orange-500" />,
      expertise: ["Personnel Management", "Operational Alignment", "Shipping Industry HR", "Team Development"],
    },
    {
      name: "Mrs. Akhila L.",
      role: "Finance Manager",
      bio: "With more than five years of financial expertise, she efficiently manages budgeting, strategic financial planning, risk analysis, and cost optimization for the company.",
      image: "/team4.jpg",
      icon: <Calculator className="h-6 w-6 text-orange-500" />,
      expertise: ["Financial Planning", "Budgeting", "Risk Analysis", "Maritime Finance"],
    },
